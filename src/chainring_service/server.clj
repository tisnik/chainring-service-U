...
(defn api-call-handler
    ...
    (if (= uri prefix)
        ...
        (condp = [method (get-api-command uri prefix)]
            ...
            [:get  "project-list"]     (rest-api/project-list-handler request)
            [:get  "project"]          (rest-api/project-handler request)
            [:get  "building"]         (rest-api/building-handler request)
            [:get  "drawing"]          (rest-api/drawing-handler request)
